...
<body style="margin: 0; overflow: hidden;">
    <div id="herramientas" class="buttons">
        <button id="btn-siguiente"> haga click!!</button>
    </div>
    ...
    <a-scene id="escenario" embedded  arjs='debugUIEnabled: false;'>
        ...
        <a-marker id="prueba" marcador  preset="hiro">
            ...
            <a-entity id="info-2">
                <a-entity text__descripcion-zas="align: center; color: #000000; value: Siguenos en nuestras redes sociales\n(has clic en los logotipos); wrapCount: 28.75" position="0 0.174 -0.534" rotation="-40 0 0"></a-entity>
                <a-entity id="app-facebook" obj-model="mtl: #facebook-mtl; obj: #facebook-obj" rotation="55.718 0 0" position="-0.639 1.147 -0.985" scale="0.414 0.414 0.414" animation="property: position; to: -0.639 1.5 -0.985; loop: true; dur: 500; dir: alternate; elasticity: 40; easing:easeInOutQuad;"></a-entity>
                <a-entity obj-model="mtl: #instagram-mtl; obj: #instagram-obj" rotation="55.718 0 0" position="0.668 1.147 -0.985" scale="0.414 0.414 0.414" animation="property: position; to: 0.668 1.5 -0.985; loop: true; dur: 500; dir: alternate; elasticity: 40; easing:easeInOutQuad;"></a-entity>
            </a-entity>
